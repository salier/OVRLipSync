...
void EmptyLinkFunctionForGeneratedCodeOVRLipSync_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_OVRLipSync()
	{
		if (!Z_Registration_Info_UPackage__Script_OVRLipSync.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_OVRLipSync_FrameSequenceCoocked__DelegateSignature,
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_OVRLipSync(Z_Construct_UPackage__Script_OVRLipSync, TEXT("/Script/OVRLipSync"), Z_Registration_Info_UPackage__Script_OVRLipSync, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0x6EC0C2CB, 0xA3250B54));
