...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UOVRLipSyncActorComponent_PermissionCallback_Statics::NewProp_Permissions = { "Permissions", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OVRLipSyncActorComponent_eventPermissionCallback_Parms, Permissions), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOVRLipSyncActorComponent_PermissionCallback_Statics::NewProp_Permissions_MetaData), Z_Construct_UFunction_UOVRLipSyncActorComponent_PermissionCallback_Statics::NewProp_Permissions_MetaData) };
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UFunction_UOVRLipSyncActorComponent_PermissionCallback_Statics::NewProp_GrantResults = { "GrantResults", nullptr, (EPropertyFlags)0x0010000008000182, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OVRLipSyncActorComponent_eventPermissionCallback_Parms, GrantResults), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UFunction_UOVRLipSyncActorComponent_PermissionCallback_Statics::NewProp_GrantResults_MetaData), Z_Construct_UFunction_UOVRLipSyncActorComponent_PermissionCallback_Statics::NewProp_GrantResults_MetaData) };
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_DefaultDeviceName_MetaData[];
#endif
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UOVRLipSyncActorComponent_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UOVRLipSyncActorComponent_FeedAudio, "FeedAudio" }, // 1259415689
		{ &Z_Construct_UFunction_UOVRLipSyncActorComponent_OnVoiceCaptureTimer, "OnVoiceCaptureTimer" }, // 4035129174
		{ &Z_Construct_UFunction_UOVRLipSyncActorComponent_PermissionCallback, "PermissionCallback" }, // 1616270198
		{ &Z_Construct_UFunction_UOVRLipSyncActorComponent_Start, "Start" }, // 2487326926
		{ &Z_Construct_UFunction_UOVRLipSyncActorComponent_Stop, "Stop" }, // 3232876224
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_UOVRLipSyncActorComponent_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UOVRLipSyncActorComponent_Statics::NewProp_DefaultDeviceName_MetaData[] = {
		{ "Category", "LipSync" },
		{ "ModuleRelativePath", "Public/OVRLipSyncLiveActorComponent.h" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UOVRLipSyncActorComponent_Statics::NewProp_DefaultDeviceName = { "DefaultDeviceName", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOVRLipSyncActorComponent, DefaultDeviceName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOVRLipSyncActorComponent_Statics::NewProp_DefaultDeviceName_MetaData), Z_Construct_UClass_UOVRLipSyncActorComponent_Statics::NewProp_DefaultDeviceName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UOVRLipSyncActorComponent_Statics::NewProp_BufferSize = { "BufferSize", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOVRLipSyncActorComponent, BufferSize), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOVRLipSyncActorComponent_Statics::NewProp_BufferSize_MetaData), Z_Construct_UClass_UOVRLipSyncActorComponent_Statics::NewProp_BufferSize_MetaData) };
...
#endif
	const UECodeGen_Private::FEnumPropertyParams Z_Construct_UClass_UOVRLipSyncActorComponent_Statics::NewProp_ProviderKind = { "ProviderKind", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Enum, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOVRLipSyncActorComponent, ProviderKind), Z_Construct_UEnum_OVRLipSync_OVRLipSyncProviderKind, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOVRLipSyncActorComponent_Statics::NewProp_ProviderKind_MetaData), Z_Construct_UClass_UOVRLipSyncActorComponent_Statics::NewProp_ProviderKind_MetaData) }; // 2072876917
#if WITH_METADATA
	...
	UOVRLipSyncActorComponent::~UOVRLipSyncActorComponent() {}
	struct Z_CompiledInDeferFile_FID_UnrealProject_liptest_Plugins_OVRLipSync_Source_OVRLipSync_Public_OVRLipSyncLiveActorComponent_h_Statics
	{
		static const FEnumRegisterCompiledInInfo EnumInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FEnumRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProject_liptest_Plugins_OVRLipSync_Source_OVRLipSync_Public_OVRLipSyncLiveActorComponent_h_Statics::EnumInfo[] = {
		{ OVRLipSyncProviderKind_StaticEnum, TEXT("OVRLipSyncProviderKind"), &Z_Registration_Info_UEnum_OVRLipSyncProviderKind, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 2072876917U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProject_liptest_Plugins_OVRLipSync_Source_OVRLipSync_Public_OVRLipSyncLiveActorComponent_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOVRLipSyncActorComponent, UOVRLipSyncActorComponent::StaticClass, TEXT("UOVRLipSyncActorComponent"), &Z_Registration_Info_UClass_UOVRLipSyncActorComponent, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOVRLipSyncActorComponent), 3221154739U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProject_liptest_Plugins_OVRLipSync_Source_OVRLipSync_Public_OVRLipSyncLiveActorComponent_h_810615830(TEXT("/Script/OVRLipSync"),
		Z_CompiledInDeferFile_FID_UnrealProject_liptest_Plugins_OVRLipSync_Source_OVRLipSync_Public_OVRLipSyncLiveActorComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProject_liptest_Plugins_OVRLipSync_Source_OVRLipSync_Public_OVRLipSyncLiveActorComponent_h_Statics::ClassInfo),
		nullptr, 0,
		Z_CompiledInDeferFile_FID_UnrealProject_liptest_Plugins_OVRLipSync_Source_OVRLipSync_Public_OVRLipSyncLiveActorComponent_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_UnrealProject_liptest_Plugins_OVRLipSync_Source_OVRLipSync_Public_OVRLipSyncLiveActorComponent_h_Statics::EnumInfo));
